...
//  Michael Sayman
//
//  Created by Kyle Ryan on 4/10/14.
//  Copyright (c) 2014 Kyle Ryan. All rights reserved.
//
...
- (void)viewDidLoad
{
   ...
   bg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 320)]; // make an imageview on the scroll
    ...
    sv.contentSize = CGSizeMake(320, (self.view.bounds.size.height*2)-160); // make it's content size bigger than the screen // adjust the variable to make sure there's no whitespace at the botton
    ...
    imv.image = [UIImage imageNamed:@"m1.png"]; // sequential images
